        ...
        <div class="flex mt-3 -mx-6">
          ...
          >
            <div class="item">
              ...
              <nuxt-link
                :to="{ name: 'projects-_id', params: { id: 1 } }"
          ...
          >
            <div class="item">
              ...
              <div class="item-meta">
                ...
                <nuxt-link
                :to="{ name: 'projects-_id', params: { id: 2 } }"
                class="text-center mt-5 button-cta block w-full bg-orange-button hover:bg-green-button text-white font-semibold px-6 py-2 text-lg rounded-full"
              >
              Fund Now
            </nuxt-link>
          ...
          >
            <div class="item">
              ...
              <div class="item-meta">
                ...
                <nuxt-link
                :to="{ name: 'projects-_id', params: { id: 3 } }"
                class="text-center mt-5 button-cta block w-full bg-orange-button hover:bg-green-button text-white font-semibold px-6 py-2 text-lg rounded-full"
              >
              Fund Now
            </nuxt-link>
          ...
          >
            <div class="item">
              ...
              <div class="item-meta">
                ...
                <nuxt-link
                :to="{ name: 'projects-_id', params: { id: 4 } }"
                class="text-center mt-5 button-cta block w-full bg-orange-button hover:bg-green-button text-white font-semibold px-6 py-2 text-lg rounded-full"
              >
              Fund Now
            </nuxt-link>
          ...
          >
            <div class="item">
              ...
              <div class="item-meta">
                ...
                <nuxt-link
                :to="{ name: 'projects-_id', params: { id: 5 } }"
                class="text-center mt-5 button-cta block w-full bg-orange-button hover:bg-green-button text-white font-semibold px-6 py-2 text-lg rounded-full"
              >
              Fund Now
            </nuxt-link>
          ...
          >
            <div class="item">
              ...
              <div class="item-meta">
                ...
                <nuxt-link
                :to="{ name: 'projects-_id', params: { id: 6 } }"
                class="text-center mt-5 button-cta block w-full bg-orange-button hover:bg-green-button text-white font-semibold px-6 py-2 text-lg rounded-full"
              >
              Fund Now
            </nuxt-link>
